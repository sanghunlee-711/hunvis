...
import selfie from "../../common/img/selfie.png";
      ...
      <TextContainer>
        ...
        <FirstCommentContainer>
          <FirstComment>
            ...
            <br />
            <span>
              개발자라는 직업의 길에 들어서 열심히 성장하고 있습니다 :)
            </span>
          </FirstComment>
          <Selfie>
        ...
        <AboutMe>
          ...
          <span>
            근본적인 지식을 중요시 여기며 가치있는 UI의 구현을 위해 새로운
            기술을 무던하게 받아들이는 태도를 가진 개발자로 성장하기 위해
            노력중입니다.
          </span>
        </AboutMe>
      </TextContainer>
...
const BannerContainer = styled.div<{ barcenloa: string }>`
  ...
  /* background: url("https://www.trentino.com/images/cms/main/754x435/B-8463-calavino-lago-di-toblino-e-castel-toblino.jpg"); */
...
const CloudWrapper = styled.div`
  ...
  img {
    ...
    max-width: 100%;
    &:nth-child(odd) {
      animation: animate calc(3s * 3) linear infinite;
    }
    &:nth-child(even) {
